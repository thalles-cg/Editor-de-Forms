document.addEventListener('DOMContentLoaded', () => {
    ...
    const apiOutputSection = document.getElementById('api-container'); 
        ...
        callApisButton.addEventListener('click', async () => {
            ...
            try {
                ...
                let generatedContent = `
                    <div class="img-row">
                        <img src="${dogImageSrc}" alt="Imagem de Cachorro">
                ...
                console.error('Erro geral ao buscar dados das APIs:', error);
